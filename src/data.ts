...
export const ROLES: Record<string, Role> = {
  mayor: {
    name: 'Mayor',
    description: 'Political leader, starts each round, enacts policies',
  },
  prospector: {
    name: 'Prospector',
    description: 'Generates gold but cannot deposit VPs this round',
  },
  producer: {
    name: 'Producer',
    description: 'Buildings produce +1 goods this round',
  },
  architect: {
    name: 'Architect',
    description:
      'Construction discount, can place servants on occupied build spaces',
  },
  thieves_guildmaster: {
    name: 'Thieves Guildmaster',
    description: 'Blocks one action space, -1 gold assassination cost',
  },
  merchant: {
    name: 'Merchant',
    description: 'Enables player-to-player trades, bonus trading actions',
  },
  recruiter: {
    name: 'Recruiter',
    description: 'Grants an extra servant this round',
  },
};
...
export const POLICIES: Record<string, Policy> = {
  ...
  corruption: {
    name: 'Corruption',
    description:
      'Players may pay 3 gold for +1 influence or lose 1 influence for +2 gold',
  },
  conscription: {
    name: 'Conscription',
    description:
      'Players may spend influence to recruit servants; recruiting action unavailable',
  },
  subsidy: {
    name: 'Subsidy',
...
export const GOODS_TYPES: Record<string, GoodsType> = {
...
export const BUILDINGS: Record<string, Building> = {
  ...
  trade_depot: {
    ...
    cost: 10,
    description:
      'Trade one additional good at Marketplace; enables player trading',
  },
  library: {
    name: 'Library',
    cost: 6,
...
export const STARTING_CHOICES: StartingChoice[] = [
  {
    name: 'Noble Heritage',
